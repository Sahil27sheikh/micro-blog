...
public class PostController {
    ...
    @GetMapping("/getComment/{postId}") // http://localhost:8081/api/posts/2aaede23-54a9-445d-b3f8-a5d6cc6c733a/comments
    @RateLimiter(name = "getCommentsRateLimiter", fallbackMethod = "commentFallback")
