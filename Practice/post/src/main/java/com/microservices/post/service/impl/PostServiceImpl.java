...
public class PostServiceImpl implements PostService {
    ...
    public PostServiceImpl(PostRepository postRepository, ModelMapper modelMapper, RestTemplate restTemplate) {
    ...
    public PostWithCommentDto postWithComments(String id) {
        ...
        ArrayList<CommentDto> commentsLists = restTemplate.getForObject
                ("http://COMMENT-SERVICE/api/comments/"+id+"/comments",
                ArrayList.class);
